...
<header class="md:hidden fixed top-0 left-0 right-0 z-20 bg-magenta_bloom-500 text-ghost_white-600">
  <div class="px-4 h-12 flex items-center justify-between">
    ...
    <button id="btnMenu" class="inline-flex items-center justify-center w-10 h-10 rounded bg-magenta_bloom-600">
...
<aside id="sidebar" class="fixed left-0 top-0 h-screen w-64 bg-magenta_bloom-500 text-ghost_white-600 shadow-lg md:flex md:flex-col z-20 transform -translate-x-full md:translate-x-0 transition-transform">
  <div class="px-4 py-4 border-b border-magenta_bloom-600">
  ...
  <nav class="p-3 flex-1 overflow-y-auto">
    <a href="index.php?page=dashboard" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
    ...
    <a href="index.php?page=customers" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
    ...
    <a href="index.php?page=suppliers" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
    ...
    <a href="index.php?page=entries&dir=receita" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
    ...
    <a href="index.php?page=entries&dir=despesa" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
    ...
    <a href="index.php?page=users" class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600">
  ...
  <div class="p-3 border-t border-magenta_bloom-600">
    <a class="flex items-center gap-3 px-3 py-2 rounded hover:bg-magenta_bloom-600" href="logout.php">
